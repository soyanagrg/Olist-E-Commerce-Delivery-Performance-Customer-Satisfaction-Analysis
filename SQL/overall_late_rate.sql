-- Question 1: What is the overall late rate?
WITH base AS (
    SELECT
        o.order_id,
        o.customer_id,
...
SELECT
    ...
    ROUND(AVG(delivery_delay_days), 1) AS avg_delay_all_orders,
    ROUND(AVG(CASE WHEN is_late = 1 THEN delivery_delay_days END), 1) AS avg_delay_late_only
FROM flagged;